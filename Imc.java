...
//                    System.out.println("ID DA FUN IMC "+id_usuario);
                ...
                JLabel lblclassificacao = new JLabel("Classificação: "+usuario.getClassificacao_p());
                JANELA.add(lblimc);
...
//                    JOptionPane.showMessageDialog(JANELA, "Digite valores válidos", "Erro", JOptionPane.ERROR_MESSAGE);
//                }
            }
        });
        ...
        btnVoltar.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                Home home = new Home(id_usuario, usuario.getNome());
                dispose();
            }
        });
    }
